...
function telephoneCheck(str) { 
  ...
  (\(\d{3}\)|\d{3}): Matches either an area code in parentheses (e.g., (555)) or a plain area code without parentheses (e.g., 555).
  ...
  \d{4}: Matches exactly four consecutive digits.
